...
const Applications = () => {
        ...
        <div className='flex gap-2 mb-6 mt-3'>
          {
            ...
            <button onClick={updatResume} className='bg-green-100 border border-green-400 rounded-lg px-4 py-2'>Save</button>
            </>
  ...
  {userApplications && userApplications.length > 0 ? (
    userApplications.map((job, index) => (
      <tr key={job._id || index}> {/* ✅ Fix: Added unique key */}
        <td className='py-3 px-4 flex items-center gap-2 border-b'>
          <img className='w-8 h-8' src={job.companyId?.image || assets.default_logo} alt="" />
